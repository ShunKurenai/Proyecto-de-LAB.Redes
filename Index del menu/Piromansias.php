...
<body>
    ...
    <div>
        <?php
                ...
                $conssult ="SELECT `ID`, `Nombre`, `Daño`, `Requisitos`, `Ubicacion`, `Descripcion`, `Imagenes` FROM `piromancias` WHERE 1";
            ...
            if($resultado->num_rows > 0){
                while($filas = $resultado->fetch_assoc()){
                    echo " <div class:\"hola\"> <img class=\"centrar\" src=\"../Imagenes/Piromancias/" . $filas["Imagenes"] . "\"" . "alt=\"\"> <h1>" . $filas["Nombre"] . "</h1>" . "<h3>". $filas["Daño"] . "</h3>" . "<h3>". $filas["Requisitos"] . "</h3>" . "<h3>". $filas["Ubicacion"] . "</h3>" . "<h3>". $filas["Descripcion"] . "</h3>" . "</div>" ;
                }
            }
        ?>
        </div>
