    ...
    <div id="header">
         <ul class="nav">
            <img src="./Imagenes/Dark_Souls_Logo.png" alt="">
             ...
             <div class="color4">
                <img class="color2 cent" src="./Submenu/Menu_Weapons.jpg" alt="">
                <img class="color2 cent" src="./Submenu/Menu_Armor.jpg" alt="">
                <img class="color2 cent" src="./Submenu/Menu_Spells.jpg" alt="">
                <img class="color2 cent" src="./Submenu/Menu_Items.jpg" alt="">
                <img class="color2 cent" src="./Submenu/Locations_Icon.jpg" alt="">
                <img class="color2 cent" src="./Submenu/Soapstone_Icon.jpg" alt="">
                <img class="color2 cent" src="./Submenu/Stats_Icon.jpg" alt="">
             </div>
         </ul>
    </div>
</body>
