...
<body>
    ...
    <div>
        <?php
                ...
                $conssult ="SELECT `ID`, `Nombre`, `Requisitos`, `Beneficios`, `Penalizaciones`, `Ubicacion`, `Descripcion`, `Imagenes` FROM `pactos` WHERE id=2";
            ...
            if($resultado->num_rows > 0){
                while($filas = $resultado->fetch_assoc()){
                    echo " <div class:\"hola\"> <img class=\"centrar\" src=\"../Imagenes/Pactos/Camino del dragon/" . $filas["Imagenes"] . "\"" . "alt=\"\"> <h1>" . $filas["Nombre"] . "</h1>" . "<h3>". $filas["Requisitos"] . "</h3>" . "<h3>". $filas["Beneficios"] . "</h3>" . "<h3>". $filas["Penalizaciones"] . "</h3>" . "<h3>". $filas["Ubicacion"] . "</h3>" . "<h3>". $filas["Descripcion"] . "</h3>" . "</div>" ;
                }
            }
        ?>
        </div>
